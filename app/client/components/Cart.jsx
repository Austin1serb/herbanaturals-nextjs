                ...
                <Box>
                    ...
                    <Box sx={{
                        ...
                        <Box className="ajax-cart--bottom-wrapper" sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <Typography sx={{ fontSize: 14, fontWeight: 100, textAlign: 'center' }} >Taxes and <Link href='/shipping-policy' onClick={() => setDrawerOpen(false)} style={{ color: 'inherit' }}>shipping</Link> calculated at checkout</Typography>
