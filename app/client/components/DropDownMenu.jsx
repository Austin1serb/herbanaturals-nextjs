...
import QuickView from '../components/QuickView'; // Assuming you have this component
            ...
            <Box className='dropdown-container'>
                <Box component='div' sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, width: '92%', }}>
                    <div className="dropdown-section">
                        ...
                        <Collapse in={openedSection === 'SHOP_ALL_CBD' ||!isMobile}>
                            <List sx={paddingSmScreen} className='list-container' >
                                <ListItem className="list-item" component={Link} href="/shop" onClick={onLinkClick}>
                                    <span className="list-content">Shop All A-Z</span>
                                </ListItem>
                                <ListItem className="list-item" component={Link} href="/shop?filter=best-sellers" onClick={onLinkClick}>
                                    <span className="list-content">Best Sellers</span>
                                </ListItem>
                                <ListItem className="list-item" component={Link} href="/shop?filter=new-products" onClick={onLinkClick}>
                                    <span className="list-content">New Products</span>
                                </ListItem>
                                <ListItem className="list-item" component={Link} href="/shop?filter=high-potency" onClick={onLinkClick}>
                                    <span className="list-content">High Potency</span>
                                </ListItem>
                                <ListItem className="list-item" component={Link} href="/shop?filter=featured" onClick={onLinkClick}>
                    ...
                    <div className="dropdown-section">
                        ...
                        <Collapse in={openedSection === 'SHOP_BY_CATEGORY' ||!isMobile}>
                            <List sx={paddingSmScreen} className='list-container'>
                                <ListItem className="list-item" component={Link} href="/shop?filter=gummies" onClick={onLinkClick}>
                                    <span className="list-content">CBD Gummies</span>
                                </ListItem>
                                <ListItem className="list-item" component={Link} href="/shop?filter=oils" onClick={onLinkClick}>
                                    <span className="list-content">CBD Oils</span>
                                </ListItem>
                                <ListItem className="list-item" component={Link} href="/shop?filter=pills" onClick={onLinkClick}>
                                    <span className="list-content">CBD Pills</span>
                                </ListItem>
                                <ListItem className="list-item" component={Link} href="/shop?filter=topicals" onClick={onLinkClick}>
                                    <span className="list-content">CBD Topicals</span>
                                </ListItem>
                                <ListItem className="list-item" component={Link} href="/shop?filter=tinctures" onClick={onLinkClick}>
                                    <span className="list-content">CBD Tinctures</span>
                                </ListItem>
                                <ListItem className="list-item" component={Link} href="/shop?filter=edibles" onClick={onLinkClick}>
                                    <span className="list-content">CBD Edibles</span>
                                </ListItem>
                                <ListItem className="list-item" component={Link} href="/shop?filter=cbd" onClick={onLinkClick}>
                    ...
                    <div className="dropdown-section">
                        ...
                        <Collapse in={openedSection === 'MORE_CANNABINOIDS' ||!isMobile}>
                            <List sx={paddingSmScreen} className='list-container'>
                                <ListItem className="list-item" component={Link} href="/shop?filter=cbn" onClick={onLinkClick}>
                                    <span className="list-content">CBN</span>
                                </ListItem>
                                <ListItem className="list-item" component={Link} href="/shop?filter=cbg" onClick={onLinkClick}>
                                    <span className="list-content">CBG</span>
                                </ListItem>
                                <ListItem className="list-item" component={Link} href="/shop?filter=CBDa" onClick={onLinkClick}>
                                    <span className="list-content">CBDa</span>
                                </ListItem>
                                <ListItem className="list-item" component={Link} href="/shop?filter=delta 9" onClick={onLinkClick}>
                    ...
                    <div className="dropdown-section" style={{ display: `${windowWidth >= 900 && windowWidth <= 1050 ? 'none' : 'block'}` }}>
                        ...
                        <Collapse in={openedSection === 'OTHER_PRODUCTS' ||!isMobile}>
                            <List sx={paddingSmScreen} className='list-container' >

                                <ListItem className="list-item" onClick={onLinkClick} component={Link} href="/shop?filter=mushrooms">
                                    <span className="list-content">Mushroom Gummies</span>
                                </ListItem>
                                <ListItem className="list-item" onClick={onLinkClick} component={Link} href="/shop?filter=kratom">
                                    <span className="list-content">Kratom</span>
                                </ListItem>
                                <ListItem className="list-item" onClick={onLinkClick} component={Link} href="/shop?filter=pet">
                    ...
                    <Box className="dropdown-section" sx={{ display: { sm: 'block', md: 'none' } }}>
                        ...
                        <Collapse in={openedSection === 'JOIN_US' ||!isMobile}>

                            <List sx={paddingSmScreen} className='list-container'>
                                <ListItem className="list-item" component={Link} href="/registration" onClick={onLinkClick}>
                    ...
                    <Box className="dropdown-section" sx={{ display: { sm: 'block', md: 'none' } }}>
                        ...
                        <Collapse in={openedSection === 'ABOUT_US' ||!isMobile}>
                            <List sx={paddingSmScreen} className='list-container'>
                                <ListItem className="list-item" component={Link} href="/about" onClick={onLinkClick}>
                    ...
                    <Box className="dropdown-section" sx={{ display: { sm: 'block', md: 'none' }, mb: 2 }}>
                        ...
                        <Collapse in={openedSection === 'SUPPORT' ||!isMobile}>
                            <List sx={paddingSmScreen} className='list-container'>
                                <ListItem className="list-item" component={Link} href="/contact" onClick={onLinkClick}>
