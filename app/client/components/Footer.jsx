        ...
        <footer className='footer-container'>
            <div style={footerStyles} >
                ...
                <Box display="flex" justifyContent="space-between" flexDirection={{ xs: 'column', sm: 'row' }}>
                    ...
                    <div>
                        <Typography variant="body2">
                            <Link href="/privacy-policy" className='footer-links'>
                                Privacy Policy
                            </Link>
                            {' | '}
                            ...
                            {' | '}
                            <Link href="/shipping-policy" className='footer-links'>
                                Shipping Policy
                            </Link>
                            {' | '}

                            <Link href='/refund' className='footer-links'>
                                Refund Policy
                            </Link>
                        </Typography>
                    </div>
                ...
                <div>
                    <Typography variant="body2" sx={{ fontSize: '12px', fontWeight: 100, marginTop: '10px' }}>
