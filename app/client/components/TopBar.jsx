            ...
            >
                {isLoggedIn ? [
                    !!isAdmin ? (<MenuItem key="admin" onClick={handleMenuClose}>
                        <Link id='link-admin' style={{ textDecoration: 'none', color: 'black' }} href='/customer/admin'>Admin</Link>
                    </MenuItem>) : (null),
            ...
            <AppBar
                ...
                <Toolbar>
                    ...
                    <Typography variant="h6" sx={{ flexGrow: 1, display: "flex", alignItems: 'center' }}>
                        <Box component={Link} href="/" className="nav-link">
                            ...
                            <Box sx={{ display: { xs: 'none', sm: 'block' }, ml: 3, mr: 1 }}>
                                <Image src={BrandText} height='80px' width='320px' alt="brand-text" className='brand-icon' />
                            </Box>
                            <Box >
                                <Image src={SmallBrandIcon} height='250' width='250' alt="brand-icon-small" className='brand-icon-small' />
                            </Box>
                        </Box>
                        <Box>
                    ...
                    {!isMobile ? (
                        <Typography component='div' className='nav-typography' variant="body1" sx={{ flexGrow: 10, display: { sm: 'none', md: 'flex', }, }}  >
                            ...
                            <Box component={Link} href='/registration' className="nav-link" sx={{ marginRight: 2 }}>
                                Join Us
                            </Box>
                            <Box component={Link} href="/about" className="nav-link" sx={{ marginRight: 2 }}>
                                About Us
                            </Box>
                            <Box component={Link} href="/contact" className="nav-link" sx={{ marginRight: 2 }}>
                                Contact
                            </Box>
