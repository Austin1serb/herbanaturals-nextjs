...
import '../app/client/Styles/Home.css';
import { Box, Typography, List, ListItem, ListItemText, ListItemIcon, CircularProgress, Button } from '@mui/material';
import Link from 'next/link';
import Image from 'next/image';
import { poppins } from '../app/client/fonts';
import BestSellersSection from '../app/client/components/BestSellersSection'
import ShopByBrand from '../app/client/components/ShopByBrand';

//lazy load my imports
//import dynamic from 'next/dynamic';
//const BestSellersSection = dynamic(() => import('./_components/BestSellersSection'));
//const ShopByBrand = dynamic(() => import('../app/client/components/ShopByBrand'));
    ...
    <div>
        ...
        <div className="left-content">
          <div className='colored-square-content'>
            <div className="colored-square">
              <h1 className={`${poppins.className}antialiased`} > Premium Herbal Products</h1>
              <Link href='/shop' >
      ...
      <Box component='div' py={{ xs: 5, sm: 16 }} sx={{ width: { xs: '320px', sm: '70%' }, height: 'auto', alignItems: 'center', justifyContent: 'center', margin: '0 auto', textAlign: 'center', mt: { xs: -30, sm: -40, md: 0 } }}>
        ...
        <Box className="bottom-box">
          <Link className='bottom-box-button1' href="/shop?filter=best-sellers">
