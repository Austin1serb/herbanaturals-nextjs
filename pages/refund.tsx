...
const RefundPolicy = () => {
    ...
    return (
        ...
        <Head>
            <title>
                Refund Policy - Herba Natural's Customer Service Guidelines
            </title>
            <meta name="description" content="Read Herba Natural's refund policy. Understand how we handle returns, refunds, and exchanges to ensure customer satisfaction." />
