...
import GuestCheckoutPage from '../app/client/components/GuestCheckout';
import { useAuth } from '../app/client/components/Utilities/useAuth';
...
const RegistrationPage = () => {
    ...
    const returnUrl = router.query.returnUrl || '/checkout';
    ...
    const shouldShowGuestCheckout = () => {
        return returnUrl.includes('/checkout');
    };
    ...
    return (
        ...
        <Head>
            ...
            <title>Create an Account - Join Herba Natural's Family</title>
            <meta name="description" content="Join the Herba Naturalfamily. Register to start purchasing high-quality CBD products and receive updates on new arrivals and offers." />
        </Head>
        <Box
