...
import '../app/client/Styles/PolicyPages.css'; // Import your CSS file for styling
...
function ShippingPolicy() {
    return (
        ...
        <Head>
            <title>
                Shipping Policy - Herba NaturalDelivery Information
            
            </title>
            <meta name="description" content="Understand Herba Natural's shipping policies. Get details on shipping methods, delivery times, and tracking your order of CBD products." />
        </Head>
