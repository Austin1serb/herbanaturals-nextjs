...
import '../app/client/Styles/PolicyPages.css';
...
const TermAndConditions = () => {
    return (
        <>
            <Head>
                <title>
                    Terms and Conditions - Understanding Your Use of Herba Natural
                </title>
                <meta name="description" content="Familiarize yourself with Herba Natural's terms and conditions. Know your rights and responsibilities as a valued customer of our CBD products." />
            </Head>
            ...
            <div className="policy-pages">
                ...
                <div className="container">
                    ...
                    <p>  The headings in this agreement are included for convenience only and will not limit or otherwise affect these Terms.</p>

                    <h3> SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h3 >

                    <p>  We are not responsible if the information on this site is not accurate, complete, or current. The material on this site is provided for general information only. It should not be relied upon or used as the sole basis for making decisions without consulting primary, more accurate, complete, or timely sources of information. Any reliance on the material on this site is at your own risk.</p>
                    ...
                    <p>  We have made every effort to display the colors and images of our products that appear at the store as accurately as possible. We cannot guarantee that your computer monitor's display of any color will be accurate.</p>
                    ...
                    <p>   You agree to provide current, complete, and accurate purchase and account information for all purchases at our store. You agree to promptly update your account and other information, including your email address and credit card numbers, and expiration dates, so that we can complete your transactions and contact you as needed.</p>

                    <p>    For more details, please review our Returns Policy.</p>

                    <h3>  SECTION 7 - OPTIONAL TOOLS</h3 >

                    <p>   We may provide you access to third-party tools we neither monitor nor have any control or input.</p>

                    <p> You acknowledge and agree that we provide access to such tools ”as is” and “as available” without any warranties, representations, or conditions and any endorsement. We shall have no liability arising from or relating to your use of optional third-party tools.</p>

                    <p>  Any use by you of optional tools offered through the site is entirely at your own risk and discretion. You should ensure that you are familiar with and approve of the terms on which tools are provided by the relevant third-party provider(s).</p>

                    <p>  In the future, we may also offer new services and/or features through the website (including the release of new tools and resources). Such new features and/or services shall also be subject to these Terms of Service.</p>

                    <h3> SECTION 8 - THIRD - PARTY LINKS</h3 >

                    <p>   Certain content, products, and services available via our Service may include third-party materials.</p>
                    ...
                    <p>  We are not liable for any harm or damages related to purchasing or using goods, services, resources, content, or other transactions connected with any third-party websites.</p>

                    <p>   Please review the third-party's policies and practices carefully and ensure you understand them before engaging in any transaction. Complaints, claims, concerns, or questions regarding third-party products should be directed to the third party.</p>
                    ...
                    <h3> SECTION 11 - SMS MARKETING</h3 >

                    <p> It is essential for consumers to understand our SMS service to make informed decisions about opting into the service. Our service consists of periodic outbound messages that include updates on product availability, special offers and discounts, exclusive deals from our business partners, tips or alerts related to products, and other helpful information. We will not send abandoned checkout reminders for customers who abandon their checkout during an online purchase. You will need to receive notifications about your order status.</p>

                    <p>  Customers can choose to unsubscribe from receiving text marketing messages at any time by replying with STOP to any mobile message sent from us or using the unsubscribe link we provided you within any of our messages. You should understand and agree that alternative methods of opting out, such as using alternative words or requests, will not be considered a reasonable means of opting out.</p>

                    <p>   We do not charge a fee for this particular service. However, message and data rates may apply. Your cell service provider may charge fees for which you are responsible. We will ensure they are addressed accordingly if there are any changed numbers or failed messages along the way.</p>
                    ...
                    <p>  These Terms of Service are effective unless and until terminated by you or us. You may terminate these Terms of Service at any time by notifying us that you no longer wish to use our Services or when you cease using our site.</p>
                    ...
                    <h3>  SECTION 20 - CHANGES TO TERMS OF SERVICES</h3 >
